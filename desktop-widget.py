...
import resources_rc
from ui_main import Ui_DesktopWidget
from PyQt5 import QtCore, QtGui, QtWidgets
import os
import random
import fnmatch

programSettings = QSettings(os.path.expanduser("~")+"/.config/desktop-widget/settings.conf", QSettings.NativeFormat)
